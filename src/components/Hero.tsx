...
/**
 * Hero-Komponente - Hauptbereich der Startseite
 * Zeigt das Logo, Hauptüberschrift und Call-to-Action-Button
 */
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-start justify-center overflow-hidden pt-16 md:pt-20 lg:pt-24 pb-8 mb-0 hero-responsive">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto fade-in flex flex-col items-center justify-center min-h-[calc(100vh-8rem)]">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-roboto-slab font-semibold text-butcher-red-light mb-3 md:mb-4 lg:mb-6 xl:mb-8 text-shadow-strong hero-title-responsive hero-title-mobile">
          <span className="text-white mr-2 font-bebas text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold">Catering Euskirchen</span>
        </h1>
        ...
        <p className="text-base sm:text-lg md:text-xl lg:text-xl xl:text-2xl text-gray-300 mb-4 md:mb-6 lg:mb-8 xl:mb-10 max-w-3xl lg:max-w-4xl mx-auto font-bold px-2 hero-subtitle-responsive hero-subtitle-mobile">
          Ultimative Grill und BBQ Erlebnisse im "<span className="text-white">Open Kitchen Style</span>"<br className="hidden lg:block" /> Ihr professioneller Catering Service in Euskirchen, Region Euskirchen und Umgebung
        </p>

        <div className="hero-button-container flex flex-col items-center mt-8 md:mt-0">
          <button
            onClick={() => scrollToSection(SECTION_IDS.CONTACT)}
            className="bg-butcher-red hover:bg-butcher-red-light text-white font-bebas text-xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-4xl px-8 sm:px-10 md:px-12 py-3 sm:py-4 md:py-5 lg:py-5 xl:py-6 rounded-none transition-all duration-300 transform hover:scale-105 glow-red mb-4 md:mb-6 lg:mb-8 xl:mb-10 hero-button-responsive hero-button-mobile focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-butcher-red"
          ...
          <button
            ...
            className="cursor-pointer float-animation mb-6 bg-transparent border-none p-0 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-butcher-black rounded"
